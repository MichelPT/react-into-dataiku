...
dss_home = os.path.expanduser(r"~\AppData\Local\Dataiku\DataScienceStudio\dss_home")
...
# Log plugin path
logging.info("Plugin library path: %s", plugin_lib)

# Check existence and list contents safely
if os.path.exists(plugin_lib):
    logging.info("Contents of plugin_lib: %s", os.listdir(plugin_lib))
else:
    logging.warning("Plugin library path does not exist: %s", plugin_lib)
